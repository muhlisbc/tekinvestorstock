...
#          puts trade_symbol[0]
 ...
 #       puts @list_of_strings
        ...
        @tickers.concat ose_tickers# removed temporarily while fetching from euronext
...
def import_nasdaq_stocks ()
    ...
    def import_ob_stocks_from_euronext
      ...
      ["AGS","NO0010778095"],
      ["AIRX-ME","NO0010895568"],
      ["AKA","NO0010215684"],
      ["AKBM-ME","NO0010886625"],
      ["AKERBP","NO0010345853"],
      ["ANDF-ME","NO0010829765"],
      ["AOW-ME","NO0010890312"],
      ["ARCHER","BMG0451H1170"],
      ["ASC","NO0003021909"],
      ["ASETEK","DK0060477263"],
      ["ATLA NOK","FO000A0DN9X4"],
      ["AVANCE","BMG067231032"],
      ["AYFIE-ME","NO0010793243"],
      ["BALT-ME","NO0010810476"],
      ["BDRILL","BMG1466R2078"],
      ["BEL","NO0003094104"],
      ["BEWI-ME","NO0010890965"],
      ["BON","NO0003110603"],
      ["BOUVET","NO0010360266"],
      ["BRA-ME","NO0010167331"],
      ["BSP-ME","NO0010755101"],
      ["CLOUD-ME","NO0010876642"],
      ["COV","SE0014731154"],
      ["CRAYON","NO0010808892"],
      ["CSAM-ME","NO0010894512"],
      ["EFUEL-ME","DK0061414711"],
      ["ELABS-ME","NO0010722283"],
      ["ELOP-ME","NO0010864036"],
      ["EPIC-ME","VGG3175Q1081"],
      ["EXTX-ME","NO0010852213"],
      ["FIVEPG","DK0060945467"],
      ["FKRAFT","NO0010815673"],
      ["GENT-ME","NO0010748866"],
      ["GEOS-ME","NO0010813843"],
      ["GRONG-ME","NO0010636491"],
      ["HAFNIA","BMG4233B1090"],
      ["HOC-ME","NO0010781818"],
      ["HUDL-ME","NO0010859648"],
      ["HUGO","DK0060945467"],
      ["HYPRO-ME","NO0010892359"],
      ["ICE","NO0010734742"],
      ["IFISH-ME","NO0010884794"],
      ["INDUCT-ME","NO0010536048"],
      ["INFRNT","NO0010789506"],
      ["INSTA-ME","NO0010762792"],
      ["ISLAX-ME","NO0010724701"],
      ["ITE","NO0010001118"],
      ["JAEREN","NO0010359433"],
      ["JPK-ME","GB00BF2PG875"],
      ["KAHOOT-ME","NO0010823131"],
      ["KAL-ME","NO0010874597"],
      ["LIFE-ME","NO0010591191"],
      ["LSTSB-ME","NO0010808405"],
      ["MNTR-ME","NO0010895022"],
      ["MRCEL-ME","NO0010307143"],
      ["NANO","NO0010597883"],
      ["NCOD-ME","NO0010892912"],
      ["NISB-ME","NO0010733082"],
      ["NORBIT","NO0010856511"],
      ["NTEL-ME","NO0010900087"],
      ["OBSERV","NO0010865009"],
      ["OHT-ME","NO0010893803"],
      ["OSUN-ME","NO0010887565"],
      ["OTELLO","NO0010040611"],
      ["PMG-ME","NO0010890726"],
      ["PPG PREF","NO0010735681"],
      ["PROTCT","NO0010209331"],
      ["PSKY-ME","NO0010895667"],
      ["QFUEL-ME","NO0010785967"],
      ["REC","NO0010112675"],
      ["RIVER-ME","MT0001710103"],
      ["ROMSB-ME","NO0010759988"],
      ["SALME-ME","NO0010892094"],
      ["SALMON","CL0002409135"],
      ["SAS NOK","SE0003366871"],
      ["SIKRI-ME","NO0010881717"],
      ["SOFTOX-ME","NO0010811961"],
      ["SRBANK","NO0010631567"],
      ["STRONG","NO0010098247"],
      ["SUNSB-ME","NO0010672900"],
      ["SUSB-ME","NO0010759780"],
      ["TECO-ME","NO0010887516"],
      ["TIETOO","FI0009000277"],
      ["TYSB-ME","NO0010731615"],
      ["ULTIMO","NO0010851603"],
      ["VACC-ME","NO0010714785"],
      ["VISTIN","NO0010734122"],
      ["VOLUE-ME","NO0010894603"],
      ["WALWIL","NO0010571680"],
      ["XPLRA-ME","NO0010895782"],
      ["ZAP-ME","NO0010713936"],
      ["ZENA-ME","CA98936C1068"],
      ["ZWIPE-ME","NO0010721277"]]
      ...
      isins.each do |stock|
        ...
        result = JSON.parse(response.body)
           ...
           if !result.nil? && !result["rows"].nil? && !result["rows"][0].nil? && !result["rows"][0]["price"].nil?
              puts stock[0] + ": " + result["rows"][0]["price"] + " (last trade at " + result["rows"][0]["time"] + ")"

              symbol = stock[0].downcase + ".ol"
